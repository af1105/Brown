...
public class MysqlDriver extends JdbcAbstractDriver {
    ...
    public String url(ConfigProperties properties) {
        ...
        return String.format("jdbc:mysql://%s:%s/%s?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT",
